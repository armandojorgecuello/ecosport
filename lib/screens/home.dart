...
import 'package:active_ecommerce_flutter/screens/upload_product.dart';
...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  fetchFeaturedProducts() async {
    ...
    _totalProductData = productResponse.meta != null ? productResponse.meta.total : 1;
                            ...
                            child: Row(
                              ...
                              children: [
                                TextButton(
                                    onPressed: (){
                                      if(is_logged_in.$ == true ){
                                        ...
                                        Toast.show('Es necesario iniciar sesión', context);
                                      }
                                    },
                                    child: Container(
                                ...
                                TextButton(
                                    onPressed: ()async{
                                      if(is_logged_in.$ == true ){
                                        final  type = 'product_upload';
                                        http.Response route;
                                        route = await UploadProduct().getRoute(type: type);
                                    ...
                                    child: Container(
                                        ...
                                        height: 80,
                                        width: 100,
                                        child: Text('Vender, Intercambiar o Regalar', textAlign: TextAlign.center, style: TextStyle( color: Colors.white ) )
                                    )
                                ),
                              ],
                            ),
