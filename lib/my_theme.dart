...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(107,141,16, 1);
  static Color soft_accent_color = Colors.white;
  static Color splash_screen_color = Colors.white; // if not sure , use the same color as accent color
