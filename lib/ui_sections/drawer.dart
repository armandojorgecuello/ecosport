...
import 'package:active_ecommerce_flutter/screens/product_list.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                is_logged_in.$ == true
                    ? ListTile(
                    leading: avatar_original.$ != null && avatar_original.$ != '' ? CircleAvatar(
                ...
                (is_logged_in.$ == true)
                    ...
                    visualDensity:
                    VisualDensity(horizontal: -4, vertical: -4),
                    leading: Icon(Icons.list_outlined,size: 16, color: Color.fromRGBO(153, 153, 153, 1)),
