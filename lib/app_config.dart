...
class AppConfig {
  static String copyright_text = "@ EcoBallution " + this_year; //this shows in the splash screen
  static String app_name = "EcoBallution"; //this shows in the splash screen
  ...
  //configure this
  static const DOMAIN_PATH = "ecosportmarket.com"; 
